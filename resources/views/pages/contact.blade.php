            ...
            <div class="row">
                ...
                <div class="col-lg-9">
                    <div id="contact" class="box">
                        ...
                        <hr>
                        <h2>Contact form</h2>
                        <form method="get" action="{{ route('check-contact') }}">
                            <div class="row">
                                <div class="col-md-6">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input id="subject" placeholder="Subject" name="subject" type="text" class="form-control">
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label for="message">Message</label>
                                        <textarea id="message" name="messagee" class="form-control"></textarea>
                                    </div>
                                </div>
                                <div class="col-md-12">
                                @if ($errors->any())
